...
class CurvePainter2 extends CustomPainter {
  Color firstColor;
  Color secondColor;
  CurvePainter2(firstColor,secondColor){
    this.firstColor=firstColor;
    this.secondColor=secondColor;
  }
  @override
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(0,0), Offset(size.width/3,0), paint2);
    canvas.drawLine(Offset(size.width/3,0), Offset(size.width*2/3,0), paint);
    canvas.drawLine(Offset(size.width*2/3,0), Offset(size.width,0), paint2);
